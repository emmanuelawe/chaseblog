...
const limit = 10
 ...
 const topBlogsResult = await Blog.find({}, project).sort('-totalViews').limit(limit)

 const recentBlogsResult = await Blog.find({}, project).sort('-createdAt').limit(limit)
